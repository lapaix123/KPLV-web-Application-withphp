    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Visitor /New Vistor</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">New Visitor Form</h5>
              ...
              <form method="post" action="../backend.php">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="names" class="form-control" placeholder="Enter Full Names" required>
                  </div>
                </div>
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="date" name="dob" class="form-control" placeholder="Select Your Birth Date" required>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <button type="submit" name="newVisitor" class="btn btn-primary">Add
                        Vistor</button>
                    </div>
                  </div>
