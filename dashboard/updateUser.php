    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">User / Update User</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-9">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form method="post">
                <div class="mb-3">
                  <label for="inputVisitorId" class="form-label">Search User</label>
                  <div class="input-group">
                    <input type="text" name="id" class="form-control" placeholder="Enter User ID or email">
          ...
          if (isset($_POST['find'])) {
            $id = $_POST['id'];
            $query = "SELECT * FROM stuff where stufCode='$id' OR email ='$id'";
              ...
              while ($row = mysqli_fetch_array($query_run)) {
                ...
                <form method="post" action="../backend.php">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="id" value="<?php echo $row['stufCode']; ?>" hidden>
                      <input type="text" name="names" class="form-control" value="<?php echo $row['snames']; ?>"
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="tell" name="phone" value="<?php echo $row['phone']; ?>" class="form-control" placeholder="Enter Phone "
                        required>
                    </div>
                  </div>
...
if (isset($_GET['userId'])) {
            $id = $_GET['userId'];
            $query = "SELECT * FROM stuff where stufCode='$id'";
