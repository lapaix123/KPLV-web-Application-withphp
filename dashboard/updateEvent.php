    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Event / Update Event</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-9">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Update Event info</h5>
              <!-- Search Form -->
              <form method="post">
                <div class="mb-3">
                  <label for="inputVisitorId" class="form-label">Search Event</label>
                  <div class="input-group">
                    <input type="text" name="id" class="form-control" placeholder="Enter Event Name or Event Code">
          ...
          if (isset($_POST['find'])) {
            $id = $_POST['id'];
            $query = "SELECT * FROM event where eCode='$id' OR eName ='$id'";
              ...
              while ($row = mysqli_fetch_array($query_run)) {
                ...
                <form method="post" action="../backend.php">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="id" value="<?php echo $row['eCode']; ?>" hidden>
                      <input type="text" name="eName" class="form-control" value="<?php echo $row['eName']; ?>"
                        placeholder="Event Name" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Coordinator</label>
                    <div class="col-sm-10">
                      <input type="text" name="cordinator" value="<?php echo $row['cordinator']; ?>" class="form-control"
                        placeholder="Cordinator" required>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select name="status" class="col-sm-2 col-form-label" required>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <button type="submit" name="eventUpdate" class="btn btn-primary">Update</button>
                    </div>
                  </div>
...
if (isset($_GET['eventId'])) {
            $id = $_GET['eventId'];
            $query = "SELECT * FROM event where eCode='$id'";
...
<div class="row mb-3">
  ...
  <div class="col-sm-10">
    <input type="text" name="cordinator" value="<?php echo $row['cordinator']; ?>" class="form-control"
      placeholder="Enter Cordinator" required>
  </div>
</div>
