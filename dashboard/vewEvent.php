    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Event / Vew Event</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        <?php
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#newUserModal">New Event</button>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td> <a href="delete.php?eventDelete=<?php echo $row['eCode']; ?>"
                                                onClick="return confirm('Are you sure want to delete RECORD?')"><button
                                                    class="btn btn-danger">delete</button></a> </td>

                                        </td>
                                        <td><a href="updateEvent.php?eventId=<?php echo $row['eCode']; ?>" onClick="return confirm('Are you sure want to Update RECORD?')"><button
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="newUserModalLabel"> New Event Registration</h5>
                            ...
                            <form method="post" action="../backend.php">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" class="form-control" placeholder="new Event Name"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputText" class="col-sm-2 col-form-label">Event Coordinator</label>
                                    <div class="col-sm-10">
              ...
              text: '$error',
                  ...
                  ?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" name="newEventview" class="btn btn-primary">Save
                                            Event</button>
                                    </div>
                                </div>
