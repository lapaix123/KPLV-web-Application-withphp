        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Visitor / View Visitor</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <?php
...
$query = mysqli_query($conn, "SELECT * FROM vistors");
if (!$query) {
        ...
        <section class="section">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#newUserModal">New Visitor</button>
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td> <a href="delete.php?visitorDelete=<?php echo $row['vistorCode'];?>"
                                                onClick="return confirm('Are you sure want to delete RECORD?')"><button
                                                    class="btn btn-danger">delete</button></a> </td>

                                        </td>
                                        <td><a href="updateVistor.php?vistorCode=<?php echo $row['vistorCode'];?>"
                                                onClick="return confirm('Are you sure want to Update RECORD?')"><button
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" action="../backend.php">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputText" class="col-sm-2 col-form-label">Natinal
                                                    Id</label>
                                                <div class="col-sm-10">
                                            ...
                                            <fieldset class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gnd"
           ...
           ?>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <button type="submit" name="newVisitorView"
                                                            class="btn btn-primary">Add Vistor</button>
                                                    </div>
                                                </div>
