        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Attendance / New Attendance</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            ...
                            if (isset($_POST['find'])) {
                                ...
                                if (!$query_run) {
                                    ...
                                    while ($row = mysqli_fetch_array($query_run)) {
                                        ?>
                                        <!-- Horizontal Form -->
                                        <form class="row g-3" method="post" action="staff.php">
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <form class="row g-3" method="post" action="staff.php">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Book Code</label>
    <div class="col-sm-10">
