...
<head>
    ...
    <style>
    .action-icon {
        max-width: 150px; /* Adjust the desired size */
        max-height: 150px; /* Adjust the desired size */
...
<body>
    ...
    <div class="row">
        <div class="col-md-3">
            <button class="btn btn-success" onclick="openSession()">
                <img src="../image/session.webp" alt="Open Session" class="action-icon">
                Open Session
            </button>
        </div>
        <div class="col-md-3">
            <button class="btn btn-danger" onclick="closeSession()">
                <img src="../image/close_session.webp" alt="Close Session" class="action-icon">
                Close Session
            </button>
        </div>
        <div class="col-md-3">
            <a href="newVistor.php">
            <button class="btn btn-primary" onclick="addVisitor()">
                <img src="../image/visitor-1.webp" alt="Add Visitor" class="action-icon">
                Add Visitor
            </button>
            </a>
        </div>
        <div class="col-md-3">
            <a href="attendance.php">
            <button class="btn btn-warning" onclick="exitVisitor()">
                <img src="../image/949229-200.webp" alt="Exit Visitor" class="action-icon">
                Exit Visitor
            </button>
            </a>
        </div>
    ...
    function openSession() {
        // Add your code to open a session here
        Swal.fire({
            icon: 'success',
            title: 'Session Opened',
            text: 'Session has been opened successfully!',
        });
    }

    function closeSession() {
        // Add your code to close a session here
        Swal.fire({
            icon: 'success',
            title: 'Session Closed',
            text: 'Session has been closed successfully!',
        });
    }

    function addVisitor() {
        // Add your code to add a visitor here
        Swal.fire({
            icon: 'success',
            title: 'Visitor Added',
    ...
    function exitVisitor() {
        // Add your code to exit a visitor here
        Swal.fire({
            icon: 'success',
            title: 'Visitor Exited',
            text: 'Visitor has exited successfully!',
        });
    }
