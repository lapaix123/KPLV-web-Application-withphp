...
attendance a
JOIN
vistors v ON a.vistor = v.vistorCode
JOIN
event e ON a.reason = e.eCode
JOIN
session s ON a.session = s.sCode
JOIN 
stuff st ON s.User = st.stufCode");
                if (!$query) {
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Attendance Liste</h5>
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr>
                                        <th>
                                            <?php echo $row['attendanceNo']; ?>
                                        </th>
                                        <td>
                                            <?php echo $row['vistorCode']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['names']; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php echo $row['belongs']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['enterTime']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['exitTime']; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo $row['VistorAttendanceCode']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['bookOut']; ?>
                                        </td>
                                    </tr>
                                <?php } ?>
